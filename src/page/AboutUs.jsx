...
const leadershipTeam = [
  { name: "Eugene Opaili", role: "Chairperson", classOf: "Class of 2016", bio: "Eugene Opaili leads the alumni network with a passion for education equity and community development.", initials: "EO", color: "from-yellow-600 to-yellow-400" },
  { name: "Brian Waf", role: "Vice Chairperson", classOf: "Class of 2014", bio: "Entrepreneur and youth advocate. Brian coordinates alumni chapters across the country and drives mentorship programmes.", initials: "BW", color: "from-amber-600 to-amber-400" },
  { name: "Richard Mukanda", role: "Secretary General", classOf: "Class of 2019", bio: "A Computer Science Student at Kenyatta University.", initials: "RM", color: "from-yellow-700 to-yellow-500" },
  { name: "Kevin Otieno Ouma", role: "Treasurer", classOf: "Class of 2011", bio: "Certified accountant with 8 years in financial services. Kevin oversees the alumni fund and scholarship disbursements.", initials: "KO", color: "from-amber-700 to-amber-500" },
  { name: "Winnie Nekesa Juma", role: "Director of Programmes", classOf: "Class of 2015", bio: "Secondary school teacher and curriculum designer. Winnie leads alumni-driven mentorship and back-to-school initiatives.", initials: "WN", color: "from-yellow-500 to-yellow-300" },
  { name: "Daniel Khisa Mulama", role: "Director of Membership", classOf: "Class of 2016", bio: "IT professional who built and manages the alumni digital platform. Daniel drives outreach and alumni registration efforts.", initials: "DK", color: "from-amber-500 to-amber-300" },
];
...
const LeaderCard = ({ leader }) => (
  <div className="group relative rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm p-6 transition-all duration-500 hover:-translate-y-1.5 hover:border-yellow-500/40 hover:shadow-[0_20px_50px_rgba(234,179,8,0.08)]">
    ...
    <p className="text-gray-400 text-sm leading-relaxed border-t border-white/5 pt-4">{leader.bio}</p>
  </div>
);
...
const AboutUs = () => {
  ...
  return (
    <div className="relative min-h-screen bg-black font-sans text-gray-300 selection:bg-yellow-500 selection:text-black overflow-hidden">
      ...
      <section className="relative py-24" data-reveal>
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
            <div>
              <h2 className="text-4xl font-bold text-yellow-500 mb-8">Our Story</h2>
            ...
            <div className="relative rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm p-8 space-y-8">
              ...
              <div>
                <h3 className="text-2xl font-bold text-yellow-500 mb-4">Core Values</h3>
                <ul className="space-y-2 text-gray-400">
                  {["Faith", "Excellence", "Integrity", "Compassion", "Stewardship"].map((v) => (
                    <li key={v} className="flex gap-2 items-center">
                      <span className="w-1.5 h-1.5 rounded-full bg-yellow-500" /> {v}
                    </li>
                  ))}
                </ul>
              </div>
      ...
      <section className="relative py-24 border-t border-white/5 bg-gradient-to-b from-black to-zinc-950" data-reveal>
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <p className="text-5xl font-extrabold text-yellow-500 mb-2 group-hover:scale-110 transition-transform duration-300">{stat.number}</p>
      ...
      <section className="relative py-24" data-reveal>
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12">
            <div>
              <h2 className="text-4xl font-bold text-yellow-500">Alumni Leadership</h2>
          ...
          <div className="mt-12 rounded-2xl border border-yellow-500/20 bg-yellow-500/5 backdrop-blur-sm p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-white font-semibold text-base">Next Elections: January 2026</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm p-8">
              <h3 className="text-2xl font-bold text-yellow-500 mb-6">Why Stay Connected?</h3>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-zinc-900 to-black border-t border-yellow-500/20 py-24">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center" data-reveal>
          <h2 className="text-4xl font-extrabold text-white mb-4">Be Part of the Legacy</h2>
